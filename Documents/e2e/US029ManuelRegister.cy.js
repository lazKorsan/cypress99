...
// npm run test:US021
    ...
    it('ManuelMethod Kayıt Testi', function() {
        ...
        cy.get('#address div:nth-child(8) input.w-full').type('123');
        cy.get('#address button.bg-primary').click();
        cy.get('#app nav.fixed a[href="#/home"]').click();
        cy.get('#app div:nth-child(1) > div.isolate > a.overflow-hidden > img.w-full').click();
